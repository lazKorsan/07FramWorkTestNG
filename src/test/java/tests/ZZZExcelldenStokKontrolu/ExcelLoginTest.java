...
public class ExcelLoginTest {
    ...
    @BeforeClass
    public void setup() {
        Driver.getDriver(); // Driver'ı başlat
    ...
    public void testLoginWithExcelData(String email, String password) throws IOException {
       ...
       // WebElement loginEmailKutusu =driver.findElement(By.id("email")) ;
      //  WebElement loginPasswordKutusu = driver.findElement(By.id("password"));
      //  WebElement loginSignInButonu = driver.findElement(By.id("submitlogin")) ;
